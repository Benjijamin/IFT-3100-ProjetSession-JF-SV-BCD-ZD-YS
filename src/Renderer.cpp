...
void Renderer::draw() {
    ...
    // Shaders disponibles
    switch (shader_active) {
    case ShaderType::color_fill:shaderColorFill();
        break;
    case ShaderType::lambert:shaderLambert();
        break;
    case ShaderType::gouraud:shaderGouraud();
        break;
    case ShaderType::phong:shaderPhong();
        break;
    case ShaderType::blinn_phong:shaderBlinnPhong();
        break;
    case ShaderType::toon:shaderToon();
        break;
    }
